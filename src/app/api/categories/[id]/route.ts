...
import { deleteCategory, updateCategory, setGapAlertsSilenced } from "@/lib/categories/service";
...
export async function PATCH(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (typeof body?.gapAlertsSilenced === "boolean") {
    await setGapAlertsSilenced(session.householdId, id, body.gapAlertsSilenced);
